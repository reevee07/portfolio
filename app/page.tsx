...
<Script async src="https://platform.twitter.com/widgets.js" strategy="lazyOnload" />
  ...
  <div style={{overflow:'hidden',height:'320px',borderRadius:'12px',border:'1px solid rgba(255,255,255,0.08)'}}>
    <iframe src="https://platform.twitter.com/embed/Tweet.html?id=1961100354122305653&theme=dark" style={{width:'142%',height:'457px',border:'none',transform:'scale(0.7)',transformOrigin:'top left'}} frameBorder="0" scrolling="no" />
  </div>
  <div style={{overflow:'hidden',height:'320px',borderRadius:'12px',border:'1px solid rgba(255,255,255,0.08)'}}>
    <iframe src="https://platform.twitter.com/embed/Tweet.html?id=2053458368652779866&theme=dark" style={{width:'142%',height:'457px',border:'none',transform:'scale(0.7)',transformOrigin:'top left'}} frameBorder="0" scrolling="no" />
  </div>
  <div style={{overflow:'hidden',height:'320px',borderRadius:'12px',border:'1px solid rgba(255,255,255,0.08)'}}>
    <iframe src="https://platform.twitter.com/embed/Tweet.html?id=2053465822757265495&theme=dark" style={{width:'142%',height:'457px',border:'none',transform:'scale(0.7)',transformOrigin:'top left'}} frameBorder="0" scrolling="no" />
  </div>
  <div style={{overflow:'hidden',height:'320px',borderRadius:'12px',border:'1px solid rgba(255,255,255,0.08)'}}>
    <iframe src="https://platform.twitter.com/embed/Tweet.html?id=2053570955759571367&theme=dark" style={{width:'142%',height:'457px',border:'none',transform:'scale(0.7)',transformOrigin:'top left'}} frameBorder="0" scrolling="no" />
  </div>
</div>
        </div>
      </section>
